...
mixin _$ValueFailure<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NotesValueFailure<T> failure) notes,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(AuthValueFailure<T> failure)? auth,
    TResult Function(NotesValueFailure<T> failure)? notes,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$_NotesCopyWith<T, $Res> {
  ...
  $Res call({NotesValueFailure<T> failure});

  $NotesValueFailureCopyWith<T, $Res> get failure;
}
...
class __$$_NotesCopyWithImpl<T, $Res>
  ...
  @override
  $NotesValueFailureCopyWith<T, $Res> get failure {
    return $NotesValueFailureCopyWith<T, $Res>(_value.failure, (value) {
      return _then(_value.copyWith(failure: value));
    });
  }
}
...
class _$_Notes<T> implements _Notes<T> {
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.notes(failure: $failure)';
  }
...
class _$ExceedingLength<T> implements ExceedingLength<T> {
  ...
  @override
  String toString() {
    return 'NotesValueFailure<$T>.exceedingLength(failedValue: $failedValue, maxLength: $maxLength)';
  }
...
class _$ListTooLong<T> implements ListTooLong<T> {
  ...
  @override
  String toString() {
    return 'NotesValueFailure<$T>.listTooLong(failedValue: $failedValue, maxLength: $maxLength)';
  }
