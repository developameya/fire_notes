...
abstract class $TodoItemCopyWith<$Res> {
  ...
  $Res call({Uid uid, TodoName name, bool done});
}
...
class _$_TodoItem extends _TodoItem {
  const _$_TodoItem({required this.uid, required this.name, required this.done})
      : super._();
  ...
  @override
  String toString() {
    return 'TodoItem(uid: $uid, name: $name, done: $done)';
  }
